...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="{{ asset('tema/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">
  <!-- Theme style -->
...
<!-- DataTables -->
<script src="{{ asset('tema/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('tema/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
<!-- SlimScroll -->
...
<!-- ChartJS -->
<script src="{{ asset('tema/bower_components/chart.js/Chart.js') }}"></script>
